            ...
            <div className='w-1/4 border-2 mx-auto rounded-lg border-slate-300'>
                <form className='flex flex-col p-4'>
                    <div className='flex justify-between items-center'>
                        <label className="py-1 text-slate-600">이메일</label>
                        <button type='button' className='flex items-end justify-center w-2/5 mb-2 py-2 font-semibold rounded-lg bg-[#1454FB] border-2 border-white text-white hover:border-[#1454FB] hover:bg-white hover:text-[#1454FB]'
                            onClick={Checked}>
                            중복 확인
                        </button>
                    </div>
